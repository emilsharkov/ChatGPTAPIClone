...
# Fetch all subnets associated with the default VPC
...
# Create an EKS cluster using the default VPC and subnets
...
# Create an EKS node group using the default subnets
